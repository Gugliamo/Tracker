...
/** \brief BME280 setup and configuration
 */
...
/** \brief Gets BME280 Temperature
 * \return double
 *
 * Returns temperature DegC, resolution is 0.01 DegC.
